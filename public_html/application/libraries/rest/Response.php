...
class Response
{
    ...
    function FormatResponse ($array = '', $format = FALSE)
    {
        ...
        if (is_array($array))
        {
            ...
            if ($this->format == 'xml') {
                ...
                $CI->load->library('rest/arraytoxml');
    ...
    function Error ($code, $additional_text = FALSE) {
        ...
        $errors = array(
            ...
            '1013' => 'Transaction declined,3-D Secure MPI Unable to authenticate',
            ...
            '2008' => 'Processor is invalid or does not belong to your merchant account.',
            ...
            '5026' => 'Invalid credit card expiry dates',
            '5027' => 'Invalid Merchant type!',
            '5028' => 'Invalid Tracking code!',
            '5029' => 'This Merchant type does not support this card brand for this transaction.',
            '5030' => 'This Merchant type does not support this method.',
            '5031' => 'This transaction is not cleared for capture. Capture is only be release after 7 days of original transaction.',
            '5033' => 'Currency not supported by gateway!',
            '5009' => 'Invalid amount.',
            ...
            '9000' => 'General Decline, no error details available.Often set by issuers fraud prevention system.',
            '9001'=>'This merchant account only accepts 3D-Secure transactions',
            '9002'=>'Invalid merchant Type provided for this account!',
            '9010'=>'IBD Mode requires customer information!',
            '9011'=>'Method is not allowed for this account!'
        );
